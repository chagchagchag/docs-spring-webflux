...
- sendMessage : chattingService 내의 sendMessage() 함수를 호출합니다. sendMessage() 함수에서는 session 에 Sinks.Many 를 이용해서 tryEmitNext() 함수를 통해서 Sink 의 Next 연산 람다식을 WebSocketSession 의 doOnNext 에 등록해줍니다.
