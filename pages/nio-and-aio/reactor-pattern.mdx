...
- Acceptor 가 handle() 을 수행할 때 ServerSocketChannel 이 accept()  성공적으로 수립했을 때 생성된 클라이언트의 SocketChannel 을 획득합니다.
...
예제는 별도의 실습 문서 들에서 따로 정리하며 예제는 아래의 두 종류를 예제로 수행합니다.<br/>
